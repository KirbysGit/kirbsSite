...
// cool little bottle component with bubble tooltip.
...
const MessageInBottleWithTooltip = () => {
    const [isCopied, setIsCopied] = useState(false);      // state for if email copied.
    const [showBubble, setShowBubble] = useState(false);  // state for if bubble is shown.

    const email = 'kirbycolin26@gmail.com';              // email to copy.
